 ...
 *
 * Additionally, it will persist the authorization in session.
 */
final class Web implements AuthenticationService {
    ...
    public function ensureCanRead(): void {
        if (!$this->isPrivileged() && !$this->configuration->public) {
            $this->forbidden();
        }
    }
