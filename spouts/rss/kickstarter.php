...
/**
 * Spout for fetching a Kickstarter project feed
 *
 * @package    spouts
 * @subpackage rss
 * @copyright  Copyright (c) Tobias Etzold (http://blog.rontu.de)
 * @license    GPLv3 (http://www.gnu.org/licenses/gpl-3.0.html)
 * @author     Tobias Etzold <info@etzold-online.de>
 */
class kickstarter extends \spouts\spout {
     ...
     * @var string
     */
    public $name = 'Kickstarter Project Feed';
     ...
     * @var string
     */
    public $description = 'A Kickstarter Project Update Feed as source';
    ...
    public function load($params) {
        ...
        @$this->feed->set_feed_url(htmlspecialchars_decode($params['url'] ."/posts.atom"));
