...
type SpoutParameterType = SpoutParameterTypePlain | SpoutParameterTypeSelect;
 ...
 * Gets all sources.
 */
export function getAllSources(abortController: AbortController): Promise<AllSourcesResponse> {
 ...
 */
export function getSpoutParams(spoutClass: string): Promise<SpoutParamsResponse> {
