...
4. Create cronjob for updating feeds and point it to http://yourselfossurl.com/update via wget or curl. You can also execute the update.php from commandline. Alternatively, you may use free cron job service EasyCron (http://www.easycron.com).
